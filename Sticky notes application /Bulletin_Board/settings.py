...
SECRET_KEY = os.environ.get('SESSION_SECRET', 'django-insecure-53=no+z7leenfqyw2wnei2qv(98+9@(r)enfo_%)17@u3@zvx-')
...
# Email — prints reset links to the console in development
